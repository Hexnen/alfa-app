...
export const TOOL_META = [
  ...
  { name: "search_events", label: "Szukaj wydarzenia", description: "Wyszukiwanie konkretnego wydarzenia po tytule/obiekcie/lokalizacji, techniku, typie lub statusie (domyślnie −90…+180 dni, najbliższe dziś pierwsze).", required: false },
  ...
  { name: "show_events", label: "Pokaż listę wydarzeń", description: "Interaktywna karta z listą wydarzeń (otwieranie, podgląd w kalendarzu, szybkie akcje) zamiast listy tekstowej.", required: false },

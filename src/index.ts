...
import { mountStatic } from "./lib/static-assets.js";
...
// Statyki frontu: cache, ETag/304 i fallback SPA — całość w src/lib/static-assets.ts
// (osobny moduł, bo tego pliku nie da się zaimportować w teście: przy imporcie
// stawia serwer, migruje bazę i uruchamia poller IMAP).
mountStatic(app, FRONTEND_DIR, () => readFileSync(`${FRONTEND_DIR}/index.html`, "utf-8"));
